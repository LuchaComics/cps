        ...
        <>
            <div class="container">
                <section class="section">
                    <Link to="/" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Home</Link>
                    <div class="content">
                        <h1 class="title is-1">Privacy Policy</h1>
                        <h3 class="title is-3">Who we are</h3>
                        <p>Collectible Protection Services - CPS</p>
