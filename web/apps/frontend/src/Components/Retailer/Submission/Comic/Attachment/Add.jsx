...
import { faTasks, faBookOpen, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs, faEye, faArrowLeft } from '@fortawesome/free-solid-svg-icons'
...
function RetailerSubmissionAttachmentAdd() {
    ...
    function onRetailerSubmissionAttachmentAddSuccess(response){
        ...
        setTimeout(() => {
            console.log("onRetailerSubmissionAttachmentAddSuccess: Delayed for 2 seconds.");
            console.log("onRetailerSubmissionAttachmentAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onRetailerSubmissionAttachmentAddError(apiErr) {
        ...
        setTimeout(() => {
            console.log("onRetailerSubmissionAttachmentAddError: Delayed for 2 seconds.");
            console.log("onRetailerSubmissionAttachmentAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/submissions/comic/${id}/attachments`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Attachments)</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link to={`/submissions/comic/${id}/attachments`} class="button is-medium is-fullwidth-mobile">
