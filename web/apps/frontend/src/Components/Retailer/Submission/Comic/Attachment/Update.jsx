            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/submissions/comic/${id}/attachment/${aid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Attachment</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link to={`/submissions/comic/${id}/attachment/${aid}`} class="button is-fullwidth-mobile">
