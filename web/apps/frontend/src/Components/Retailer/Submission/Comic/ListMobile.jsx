...
*/
function RetailerComicSubmissionListMobile(props) {
            ...
            {listData && listData.results && listData.results.map(function(datum, i){
                return <div class="mb-5">
                    ...
                    {datum.customerId !== undefined && datum.customerId !== null && datum.customerId !== ""
                        ?
                        <>
                            {datum.customerId !== "000000000000000000000000" && <Link to={`/customer/${datum.customerId}`} target="_blank" rel="noreferrer" class="is-small">
                    ...
                    <div class="is-hidden-mobile pt-2">
                        <div className="buttons is-right">
                            <Link to={`/submissions/comic/${datum.id}`} class="button is-small is-primary" type="button">
                    ...
                    <div class="is-hidden-tablet pt-2">
                        <div class="columns is-mobile">
                            <div class="column">
                                <Link to={`/submissions/comic/${datum.id}`} class="button is-small is-primary is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                                </Link>
                            </div>
                        </div>
...
export default RetailerComicSubmissionListMobile;
