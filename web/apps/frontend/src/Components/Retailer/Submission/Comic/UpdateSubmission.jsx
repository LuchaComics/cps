...
import { faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faPencil, faEye, faGauge, faBookOpen,faBook, faMagnifyingGlass, faBalanceScale, faArrowUpRightFromSquare, faCog } from '@fortawesome/free-solid-svg-icons'
...
function RetailerComicSubmissionUpdateForComicSubmission() {
    ...
    const [showsSignsOfTamperingOrRestoration, setShowsSignsOfTamperingOrRestoration] = useState(2); // 2=No
    ...
    const onSubmitClick = (e) => {
        ...
        // Generate the payload in `snake-case` format for our API.
        const submission = {
            id: id,
        ...
        putComicSubmissionUpdateAPI(submission, onComicSubmissionUpdateSuccess, onComicSubmissionUpdateError, onComicSubmissionUpdateDone, onUnauthorized);
    }
    ...
    const cpsPercentageGradeFilterOptions = (options, storeLevel, serviceType) => {
    ...
    // Special thanks via:
    // https://github.com/LuchaComics/cps-frontend/issues/160
    const overallNumberGradeFilterOptions = (options, storeLevel, serviceType) => {
        return options.filter((option) => {
            if (storeLevel === 1) {
    ...
    const cpsPercentageGradeFilteredOptions = cpsPercentageGradeFilterOptions(CPS_PERCENTAGE_GRADE_WITH_EMPTY_OPTIONS, currentUser.storeLevel, serviceType);
    const overallNumberGradeFilteredOptions = overallNumberGradeFilterOptions(OVERALL_NUMBER_GRADE_WITH_EMPTY_OPTIONS, currentUser.storeLevel, serviceType);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to="/submissions/comics" aria-current="page"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Online Submissions</Link></li>
                            <li class=""><Link to="/submissions/comics" aria-current="page"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Comics</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/submissions/comic/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Details</Link></li>
                        </ul>
                    </nav>

                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Comic Submission</p>
                            ...
                            <>
                                <div class="container">
                                    ...
                                    <FormCheckboxField
                                        ...
                                        onChange={(e)=>setIsInternationalEdition(!isInternationalEdition)}
                                        maxWidth="180px"
                                    />
                                    ...
                                    {isVariantCover === true && <FormTextareaField
                                    ...
                                    <FormComicSignaturesTable
                                        ...
                                        disabled={true}
                                        helpText={<>Only available to CPS, <a href="mailto:support@cpscapsule.com">contact us&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowUpRightFromSquare} /></a> if you are interested in learning more.</>}
                                    />
                                    ...
                                    {serviceType !== SERVICE_TYPE_CPS_CAPSULE_INDIE_MINT_GEM &&
                                        ...
                                        <FormRadioField
                                            ...
                                            onChange={(e)=>setShowsSignsOfTamperingOrRestoration(parseInt(e.target.value))}
                                            maxWidth="180px"
                                        />
                                    ...
                                    <FormTextChoiceRow
                                        ...
                                        value={status}
                                        opt1Value={1}
                                        opt1Label="Waiting to Receive"
                                        opt2Value={2}
                                        opt2Label="Received"
                                        opt3Value={3}
                                        opt3Label="Pending"
                                        opt4Value={4}
                                        opt4Label="In Process"
                                        opt4Value={5}
                                        opt4Label="Complete"
                                        opt4Value={6}
                                        opt4Label="Shipped/Ready for pickup"
                                    />

                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link to={`/submissions/comic/${id}`} class="button is-medium is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <button class="button is-medium is-primary is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Save</button>
                                        </div>
                                    </div>
