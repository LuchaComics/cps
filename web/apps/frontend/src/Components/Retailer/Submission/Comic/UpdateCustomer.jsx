...
import { faTasks, faBookOpen, faTachometer, faPlus, faArrowLeft, faCheckCircle, faPencil, faEye, faGauge } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/submissions/comic/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Details</Link></li>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <button class="button is-primary is-medium is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Save</button>
                                        </div>
                                    </div>
