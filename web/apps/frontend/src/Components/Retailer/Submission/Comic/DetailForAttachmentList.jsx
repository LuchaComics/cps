                                ...
                                {submission && <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/submissions`}>
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comic Submissons
                                            </Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/submissions/comic/${id}/attachments/add`} class="button is-primary is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add Attachment
                                            </Link>
                                        </div>
                                    </div>
