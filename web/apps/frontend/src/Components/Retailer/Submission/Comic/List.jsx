...
import RetailerComicSubmissionListDesktop from "./ListDesktop";
import RetailerComicSubmissionListMobile from "./ListMobile";
...
function RetailerComicSubmissionList() {
    ...
    const [actualSearchText, setActualSearchText] = useRecoilState(submissionFilterActualSearchTextState);          // Searching - The actual search query value to submit to the API.
    const [status, setStatus] = useRecoilState(submissionFilterStatusState);                                        // Filtering
    const [createdAtGTE, setCreatedAtGTE] = useRecoilState(submissionFilterJoinedAfterState);                       // Filtering
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/submissions`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Online Submissions</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        <div class="columns">
                            <div class="column is-8">
                                <h1 class="title is-4"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Online Comic Submissions for: {currentUser && currentUser.storeName}</h1>
                            </div>
                            ...
                            <div className="column has-text-right is-hidden-desktop is-hidden-tablet">
                                ...
                                &nbsp;
                                <Link to={`/submissions/comics/add/search`} class="button is-small is-primary is-fullwidth" type="button">
                                    ...
                                    <div class="container">
                                        ...
                                        */}
                                        <div class="is-hidden-touch" >
                                            <RetailerComicSubmissionListDesktop
                                        ...
                                        */}
                                        <div class="is-fullwidth is-hidden-desktop">
                                            <RetailerComicSubmissionListMobile
                                                listData={submissions}
                                                setPageSize={setPageSize}
                                                pageSize={pageSize}
                                                previousCursors={previousCursors}
                        ...
                        <div class="columns pt-4">
                            <div class="column is-half">
                                <Link to={`/dashboard`} class="button is-medium is-fullwidth-mobile">
