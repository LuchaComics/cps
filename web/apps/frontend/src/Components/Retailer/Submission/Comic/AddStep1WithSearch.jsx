                ...
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        <div class="container pb-6">
                            ...
                            <Link class="is-medium is-danger" to="/submissions/comics/add/starred">Select from starred customers&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>&nbsp;&nbsp;<br /><br />
...
export default RetailerComicSubmissionAddStep1WithSearch;
