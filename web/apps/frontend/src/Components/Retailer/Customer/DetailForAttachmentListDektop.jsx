...
function RetailerCustomerDetailForAttachmentDesktop(props) {
                            ...
                            return <tr>
                                ...
                                <td class="is-actions-cell">
                                    <div class="buttons is-right">
                                        <Link to={`/customer/${userID}/attachment/${attachment.id}`} class="button is-small is-primary" type="button">
                                            View
                                        </Link>
                                        <Link to={`/customer/${userID}/attachment/${attachment.id}/edit`} class="button is-small is-warning" type="button">
                                            Edit
                                        </Link>
...
export default RetailerCustomerDetailForAttachmentDesktop;
