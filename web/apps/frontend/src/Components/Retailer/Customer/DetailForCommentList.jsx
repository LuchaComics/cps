...
function RetailerCustomerDetailForCommentList() {
    ...
    const onSubmitClick = (e) => {
        ...
        setErrors(null);
        setFetching(true);
        postCustomerCreateCommentOperationAPI(id, content, onCustomerUpdateSuccess, onCustomerUpdateError, onCustomerUpdateDone, onUnauthorized);
    }
                                ...
                                {customer && <div class="container">
                                    ...
                                    <div class="columns pt-4">
                                        <div class="column is-half">
                                            <Link to={`/customers`} class="button is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Customers</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <button onClick={onSubmitClick} class="button is-primary is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add Comment
                                            </button>
                                        </div>
                                    </div>
