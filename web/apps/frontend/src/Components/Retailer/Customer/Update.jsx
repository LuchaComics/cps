...
function RetailerCustomerUpdate() {
    ...
    const onSubmitClick = (e) => {
        ...
        putCustomerUpdateAPI(customer, onRetailerCustomerUpdateSuccess, onRetailerCustomerUpdateError, onRetailerCustomerUpdateDone, onUnauthorized);
    }
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/customer/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/customer/${id}`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        </div>
