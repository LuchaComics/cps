...
import { faArrowLeft, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function RetailerCustomerAdd() {
    ...
    const onSubmitClick = (e) => {
        ...
        postCustomerCreateAPI(customer, onRetailerCustomerAddSuccess, onRetailerCustomerAddError, onRetailerCustomerAddDone, onUnauthorized);
    }
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Customer</p>
