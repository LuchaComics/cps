...
import { faTrashCan, faStar, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faIdCard, faAddressBook, faContactCard, faChartPie } from '@fortawesome/free-solid-svg-icons'
import { useRecoilState } from 'recoil';
import { useParams } from 'react-router-dom';

import useLocalStorage from "../../../Hooks/useLocalStorage";
import { getCustomerDetailAPI, postCustomerStarOperationAPI, deleteCustomerAPI } from "../../../API/customer";
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/customers`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Customers</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        {customer && <div class="columns">
                            ...
                            <div class="column has-text-right">
                                <Link to={`/submissions/pick-type-for-add?customer_id=${id}&customer_name=${customer.name}`} class="button is-small is-success is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;CPS
                                </Link>&nbsp;&nbsp;
                                <Link to={`/customer/${customer.id}/edit`} class="button is-small is-warning is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit
                                </Link>&nbsp;&nbsp;
                                <button onClick={(e, ses) => onSelectCustomerForDeletion(e, customer)} class="button is-small is-danger is-fullwidth-mobile" type="button">
                            ...
                            <>
                                {customer && <div class="container">
                                    ...
                                    <div class="columns">
                                        ...
                                        {customer.hasShippingAddress &&<div class="column">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/customers`}>
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Customers</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/customer/${id}/edit`} class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                        </div>
                                    </div>
