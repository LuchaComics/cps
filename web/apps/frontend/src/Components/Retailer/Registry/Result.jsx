            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/registry`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Registry</Link></li>
                        </ul>
                    </nav>
                                ...
                                {submission && <div class="container">
                                    ...
                                    <div class="columns pt-4">
                                        <div class="column is-half">
                                            <Link to={`/registry`} class="button is-medium is-fullwidth-mobile">
