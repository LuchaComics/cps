                        ...
                        <section class="hero is-medium is-link">
                          <div class="hero-body">
                            ...
                            <p class="subtitle">
                              ...
                              <br />
                              <br />
                              <Link to={"/submissions/comics"}>View Online Comic Submissions&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                              <br />
                              <br />
                              <Link to={"/submissions/pick-type-for-add"}>New&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                            </p>
                          </div>
                        </section>
