...
import { faCogs, faChartPie, faIdCard, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faGauge, faPencil, faBuilding } from '@fortawesome/free-solid-svg-icons'
...
function StoreUpdate() {
    ...
    const onSubmitClick = (e) => {
        ...
        putStoreUpdateAPI(org, onStoreUpdateSuccess, onStoreUpdateError, onStoreUpdateDone, onUnauthorized);
    }
    ...
    function onStoreUpdateSuccess(response){
        ...
        setTimeout(() => {
            ...
            console.log("onStoreUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onStoreUpdateError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onStoreUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to="/store" aria-current="page"><FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;My Store</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/store`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to My Store</Link></li>
                        </ul>
                    </nav>

                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;My Store</p>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={"/store"}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        </div>
