            ...
            <section className="section">
             ...
             <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                 <ul>
                     ...
                     <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faShoppingCart} />&nbsp;Purchases</Link></li>
                 </ul>
             </nav>
              ...
              <nav className="box">
                ...
                <div className="columns">
                  ...
                  <div className="column has-text-right">
                      <button onClick={()=>fetchList(currentCursor, pageSize, actualSearchText, id)} class="is-fullwidth-mobile button is-link is-small" type="button">
