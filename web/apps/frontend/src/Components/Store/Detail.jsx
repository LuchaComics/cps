                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;My Store</Link></li>
                        </ul>
                    </nav>
                                ...
                                {store && <div class="container">
                                    <div class= "tabs is-medium is-size-7-mobile">
                                      <ul>
                                        ...
                                        <li>
                                            <Link to={`/store/${store.id}/purchases`}>Purchases</Link>
                                        </li>
                                        <li>
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={"/store/update"} class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                        </div>
                                    </div>
