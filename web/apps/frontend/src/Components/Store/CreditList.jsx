...
import { faRefresh, faTable, faDonate, faBuilding, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faArrowRight, faTrashCan, faArrowUpRightFromSquare } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faDonate} />&nbsp;Credits</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            <div class="column has-text-right">
                                ...
                                */}
                                <button onClick={()=>fetchSubmissionList(currentCursor, id, pageSize)} class="is-fullwidth-mobile button is-link is-small" type="button">
                                ...
                                {user && <div class="container">
                                    <div class= "tabs is-medium is-size-7-mobile">
                                      <ul>
                                        ...
                                        <li class={`is-active`}>
                                            <Link to={`/store/${id}/credits`}><b>Credits</b></Link>
                                        </li>
                                      </ul>
                                    </div>
