...
import { faArrowUpRightFromSquare, faArrowLeft, faHandHolding, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faIdCard, faAddressBook, faMessage, faChartPie, faCogs, faEye } from '@fortawesome/free-solid-svg-icons'
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                      <ul>
                        <li class=""><Link to={`/admin/offer/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link></li>
                      </ul>
                    </nav>
                    ...
                    <nav class="box">
                        ...
                        <div class="container">
                            ...
                            <hr />
                            <p>Please note some of the fields are <i>read-only</i> and can only be edited via <Link to="https://stripe.com" target="_blank" rel="noreferrer">Stripe, Inc.&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link>.</p>
                            <br />
