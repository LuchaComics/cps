                ...
                return <div class="mb-5">
                    ...
                    <div class="is-hidden-mobile pt-2">
                        <div className="buttons is-right">
                            <Link to={`/admin/submissions/comic/${datum.id}`} target="_blank" rel="noreferrer" class="button is-small is-primary" type="button">
                                View&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                            </Link>
                            <Link to={`/admin/submissions/comic/${datum.id}/edit`} target="_blank" rel="noreferrer" class="button is-small is-warning" type="button">
                    ...
                    <div class="is-hidden-tablet pt-2">
                        <div class="columns is-mobile">
                            <div class="column">
                                <Link to={`/admin/submissions/comic/${datum.id}`} target="_blank" rel="noreferrer" class="button is-small is-primary is-fullwidth" type="button">
                                    View&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                                </Link>
                            </div>
                            <div class="column">
                                <Link to={`/admin/submissions/comic/${datum.id}/edit`} target="_blank" rel="noreferrer" class="button is-small is-warning is-fullwidth" type="button">
                                    Edit&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                                </Link>
                            </div>
                            <div class="column">
