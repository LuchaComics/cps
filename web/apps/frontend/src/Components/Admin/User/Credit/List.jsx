...
function AdminUserCreditList() {
    ...
    const [selectedCreditForDeletion, setSelectedCreditForDeletion] = useState("");
    ...
    function onCreditDeleteError(apiErr) {
        ...
        setTimeout(() => {
            console.log("onCreditDeleteError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Credits)</Link></li>
                        </ul>
                    </nav>
                    ...
                    <div class={`modal ${selectedCreditForDeletion ? 'is-active' : ''}`}>
                        ...
                        <div class="modal-card">
                            <header class="modal-card-head">
                                ...
                                <button class="delete" aria-label="close" onClick={onDeselectCreditForDeletion}></button>
                            </header>
                            <section class="modal-card-body">
                                You are about to <b>archive</b> this credit; it will no longer appear on your dashboard This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?
                            </section>
                            <footer class="modal-card-foot">
                                <button class="button is-success" onClick={onDeleteConfirmButtonClick}>Confirm</button>
                                <button class="button" onClick={onDeselectCreditForDeletion}>Cancel</button>
                            </footer>
                        </div>
                    </div>
                                ...
                                {user && <div class="container">
                                    <div class= "tabs is-medium is-size-7-mobile">
                                      <ul>
                                        ...
                                        <li class="is-active">
                                            <Link to={`/admin/user/${user.id}/credits`}><b>Credits</b></Link>
                                        </li>
                                      </ul>
                                    </div>

                                    {!isFetching && credits && credits.results && (credits.results.length > 0 || previousCursors.length > 0)
                                        ?
                                        <div class="container">
                                            {/*
                                                ##################################################################
                                            ...
                                            */}
                                            <div class="is-hidden-touch" >
                                                <AdminUserCreditListDesktop
                                                    ...
                                                    onSelectCreditForDeletion={onSelectCreditForDeletion}
                                                />
                                            </div>
                                        ...
                                        <div class="container">
                                            <article class="message is-dark">
                                                <div class="message-body">
                                                    No credits. <b><Link to={`/admin/user/${id}/credits/add`} >Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating a new credit.
                                                </div>
                                            </article>
                                        </div>
                                    }
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/user/${id}/credits/add`} class="button is-primary is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Credit
                                            </Link>
                                        </div>
                                    </div>
