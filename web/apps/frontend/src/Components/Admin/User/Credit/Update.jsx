...
import { faDonate, faEye, faArrowLeft, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faIdCard, faAddressBook, faContactCard, faChartPie, faBuilding, faCogs } from '@fortawesome/free-solid-svg-icons'
...
import { CREDIT_BUSINESS_FUNCTION_WITH_EMPTY_OPTIONS, CREDIT_STATUS_WITH_EMPTY_OPTIONS } from "../../../../Constants/FieldOptions";
...
function AdminUserCreditUpdate() {
    ...
    const onSubmitClick = (e) => {
        ...
        putCreditUpdateAPI(credit, onAdminUserCreditUpdateSuccess, onAdminUserCreditUpdateError, onAdminUserCreditUpdateDone, onUnauthorized);
    }
    ...
    function onAdminUserCreditUpdateSuccess(response){
        ...
        setTimeout(() => {
            ...
            console.log("onAdminUserCreditUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminUserCreditUpdateError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onAdminUserCreditUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/admin/user/${id}/credits`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Credits)</Link></li>
                            <li class=""><Link to={`/admin/user/${id}/credit/${cid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faDonate} />&nbsp;Credit</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/credits`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Credits</Link></li>
                        </ul>
                    </nav>

                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Update Credit</p>
                        ...
                        {isFetching
                            ...
                            <>
                                ...
                                <div class="container">
                                    ...
                                    {businessFunction === 1 && <FormSelectFieldForOffer
                                        label="Offer"
                                        offerID={offerID}
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-medium is-fullwidth-mobile" to={`/admin/user/${id}/credit/${cid}`}><FontAwesomeIcon className="fas" icon={faTimesCircle} />&nbsp;Cancel</Link>
                                        </div>
