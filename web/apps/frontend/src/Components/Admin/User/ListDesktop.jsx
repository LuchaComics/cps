                    ...
                    <tbody>
                        ...
                        {listData && listData.results && listData.results.map(function(user, i){
                            return <tr>
                                ...
                                <td data-label="Store">
                                    {user.storeId !== "000000000000000000000000" && <Link to={`/admin/store/${user.storeId}`} target="_blank" rel="noreferrer" class="is-small">
                                        {user.storeName}&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                                    </Link>}
                                </td>
