                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            {user && <div class="column has-text-right">
                                <Link to={`/admin/user/${id}/attachments/add`} class="button is-small is-success is-fullwidth-mobile" type="button">
                                ...
                                {user && <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/user/${id}/attachments/add`} class="button is-primary is-fullwidth-mobile">
