...
import { faFilterCircleXmark, faArrowLeft, faUsers, faTachometer, faEye, faPencil, faTrashCan, faPlus, faGauge, faArrowRight, faTable, faBuilding, faRefresh, faFilter, faSearch  } from '@fortawesome/free-solid-svg-icons';
...
function AdminStoreList() {
    ...
    const [temporarySearchText, setTemporarySearchText] = useRecoilState(storeFilterTemporarySearchTextState); // Searching - The search field value as your writes their query.
    const [actualSearchText, setActualSearchText] = useRecoilState(storeFilterActualSearchTextState);          // Searching - The actual search query value to submit to the API.
    const [status, setStatus] = useRecoilState(storeFilterStatusState);                                        // Filtering
    const [createdAtGTE, setCreatedAtGTE] = useRecoilState(storeFilterJoinedAfterState);                       // Filtering
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;Stores</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        <div class="columns">
                            <div class="column">
                                <h1 class="title is-4"><FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;Stores List</h1>
                            </div>
                            ...
                            <div className="column has-text-right is-hidden-desktop is-hidden-tablet">
                                ...
                                &nbsp;
                                <Link to={`/admin/stores/add`} class="button is-small is-primary is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;New Store
                                </Link>
                            </div>
                            ...
                            <div className="column has-text-right is-hidden-mobile">
                                ...
                                &nbsp;
                                <Link to={`/admin/stores/add`} class="button is-small is-primary" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;New Store
                                </Link>
                            </div>
                        </div>
                        ...
                        {isFetching
                            ...
                            <>
                                ...
                                {stores && stores.results && (stores.results.length > 0 || previousCursors.length > 0)
                                    ?
                                    <div class="container">
                                        {/*
                                            ##################################################################
                                    ...
                                    <section class="hero is-medium has-background-white-ter">
                                          <div class="hero-body">
                                            <p class="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No Stores
                                            </p>
                                            <p class="subtitle">
                                                No stores. <b><Link to="/admin/stores/add">Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating your first store.
                                            </p>
                                          </div>
                                    </section>
                                }
