                ...
                {listData && listData.results && listData.results.map(function (datum, i) {
                    return (
                        ...
                        <td data-label="Submission">
                            <Link target="_blank" rel="noreferrer" to={`/admin/submissions/comic/${datum.comicSubmissionId}`}>
                                {datum.comicSubmissionSeriesTitle}&nbsp;{datum.comicSubmissionSeriesIssueVol}&nbsp;{datum.comicSubmissionSeriesIssueNo}&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                            </Link>
                        </td>
                        <td data-label="Purchase Date">{DateTime.fromISO(datum.paymentProcessorPurchasedAt).toLocaleString(DateTime.DATETIME_MED)}</td>
                        <td className="is-actions-cell">
                          <div className="buttons is-right">
                            <Link target="_blank" rel="noreferrer" to={datum.paymentProcessorReceiptUrl} className="button is-small is-dark" type="button">
                                View Receipt&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                            </Link>
                          </div>
                        </td>
                        </tr>
