...
*/
function AdminStorePurchaseListMobile(props) {
        ...
        <>
            {listData && listData.results && listData.results.map(function (datum, i) {
                return <div class="pb-2" key={`mobile_tablet_${datum.id}`}>
                    ...
                    <br />
                    <br />
                    <strong>Subtotal:</strong>&nbsp;${datum.amountSubtotal}&nbsp;{datum.priceCurrency}
                    <br />
                    <br />
                    <strong>Tax:</strong>&nbsp;${datum.amountTax}&nbsp;{datum.priceCurrency}
                    <br />
                    <br />
                    <strong>Total:</strong>&nbsp;${datum.amountTotal}&nbsp;{datum.priceCurrency}
                    <br />
                    <br />
                    {/* Tablet only */}
                    <div class="is-hidden-mobile" key={`tablet_${datum.id}`}>
                        <div className="buttons is-right">
                            <Link to={`/admin/offer/${datum.id}`} class="button is-small is-dark" type="button">
                    ...
                    <div class="is-hidden-tablet" key={`mobile_${datum.id}`}>
                        <div class="columns is-mobile">
                            <div class="column">
                                <Link to={`/admin/offer/${datum.id}`} class="button is-small is-dark is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                                </Link>
                            </div>
                        </div>
...
export default AdminStorePurchaseListMobile;
