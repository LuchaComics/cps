...
import { faTrashCan, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faBuilding, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function AdminStoreDetail() {
    ...
    function onStoreDeleteError(apiErr) {
        ...
        setTimeout(() => {
            console.log("onStoreDeleteError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/stores`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Stores</Link></li>
                        </ul>
                    </nav>
                    ...
                    <div class={`modal ${selectedStoreForDeletion ? 'is-active' : ''}`}>
                        ...
                        <div class="modal-card">
                            <header class="modal-card-head">
                                ...
                                <button class="delete" aria-label="close" onClick={onDeselectStoreForDeletion}></button>
                            </header>
                            <section class="modal-card-body">
                                You are about to <b>archive</b> this store; it will no longer appear on your dashboard This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?
                            </section>
                            <footer class="modal-card-foot">
                                <button class="button is-success" onClick={onDeleteConfirmButtonClick}>Confirm</button>
                                <button class="button" onClick={onDeselectStoreForDeletion}>Cancel</button>
                            </footer>
                        </div>
                    </div>
                    ...
                    {/* Page */}
                    <nav class="box">
                        {store && <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;Store</p>
                            </div>
                            <div class="column has-text-right">
                                <Link to={`/admin/submissions/pick-type-for-add?org_id=${store.id}`} class="button is-small is-success is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;CPS
                                </Link>&nbsp;
                                <Link to={`/admin/store/${store.id}/edit`} class="button is-small is-warning is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit
                                </Link>&nbsp;
                                <button onClick={(e, ses) => onSelectStoreForDeletion(e, store)} class="button is-small is-danger is-fullwidth-mobile" type="button">
                                ...
                                {store && <div class="container">
                                    <div class= "tabs is-medium is-size-7-mobile">
                                      <ul>
                                        ...
                                        <li>
                                            <Link to={`/admin/store/${store.id}/purchases`}>Purchases</Link>
                                        </li>
                                      </ul>
                                    </div>
                                    ...
                                    {store.hasOtherGradingService === 1 && <FormRowText
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/store/${id}/edit`} class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                        </div>
                                    </div>
