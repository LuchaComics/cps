...
function AdminStoreAttachmentUpdate() {
    ...
    function onAdminStoreAttachmentUpdateSuccess(response){
        ...
        setTimeout(() => {
            console.log("onAdminStoreAttachmentUpdateSuccess: Delayed for 2 seconds.");
            console.log("onAdminStoreAttachmentUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminStoreAttachmentUpdateError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onAdminStoreAttachmentUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminStoreAttachmentDetailError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onAdminStoreAttachmentDetailError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/admin/store/${id}/attachment/${aid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faFile} />&nbsp;Attachment</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/store/${id}/attachment/${aid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Attachment</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link to={`/admin/store/${id}/attachment/${aid}`} class="button is-hidden-touch"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                            <Link to={`/admin/store/${id}/attachment/${aid}`} class="button is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        </div>
