...
import { faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faGauge, faPencil, faUsers, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faBuilding, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function AdminStoreUpdate() {
    ...
    const [estimatedSubmissionsPerMonth, setEstimatedSubmissionsPerMonth] = useState("");
    ...
    const onSubmitClick = (e) => {
        ...
        putStoreUpdateAPI(store, onAdminStoreUpdateSuccess, onAdminStoreUpdateError, onAdminStoreUpdateDone, onUnauthorized);
    }
    ...
    function onProfileDetailSuccess(response){
        ...
        setEstimatedSubmissionsPerMonth(parseInt(response.estimatedSubmissionsPerMonth));
    ...
    function onAdminStoreUpdateSuccess(response){
        ...
        setTimeout(() => {
            ...
            console.log("onAdminStoreUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminStoreUpdateError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onAdminStoreUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/admin/store/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/store/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link></li>
                        </ul>
                    </nav>

                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faBuilding} />&nbsp;Store</p>
                            ...
                            <>
                                <div class="container">
                                    ...
                                    <FormSelectField
                                        ...
                                        helpText=""
                                        onChange={(e)=>setEstimatedSubmissionsPerMonth(parseInt(e.target.value))}
                                    ...
                                    <FormRadioField
                                        ...
                                        onChange={(e)=>setHasOtherGradingService(parseInt(e.target.value))}
                                        maxWidth="180px"
                                    />
                                    ...
                                    <FormRadioField
                                        ...
                                        onChange={(e)=>setRequestWelcomePackage(parseInt(e.target.value))}
                                        maxWidth="180px"
                                    />
                                    ...
                                    <FormSelectField
                                        ...
                                        helpText=""
                                        onChange={(e)=>setHowLongStoreOperating(parseInt(e.target.value))}
                                        options={HOW_LONG_HAS_YOUR_STORE_BEEN_OPERATING_FOR_WITH_EMPTY_OPTIONS}
                                    />
                                    ...
                                    <FormSelectField
                                        ...
                                        helpText=""
                                        onChange={(e)=>setSpecialCollection(parseInt(e.target.value))}
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/admin/store/${id}`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <button class="button is-primary is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Save</button>
                                        </div>
                                    </div>
