...
*/
function AdminStoreDetailForUserListMobile(props) {
        ...
        <>
            {listData && listData.results && listData.results.map(function(datum, i){
                return <div class="mb-5">
                    ...
                    <br />
                    <br />
                    <strong>Phone:</strong>&nbsp;<Link to={`tel:${datum.phone}`}>{datum.phone}</Link>
                    <br />
                    <br />
                    ...
                    <div class="is-hidden-mobile pt-2">
                        <div className="buttons is-right">
                            <Link to={`/admin/submissions/pick-type-for-add?user_id=${datum.id}&user_name=${datum.name}`} target="_blank" rel="noreferrer" class="button is-small is-success" type="button">
                                <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;CPS&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                            </Link>
                            <Link to={`/admin/user/${datum.id}`} target="_blank" rel="noreferrer" class="button is-small is-primary" type="button">
                                View&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                            </Link>
                            <Link to={`/admin/user/${datum.id}/edit`} target="_blank" rel="noreferrer" class="button is-small is-warning" type="button">
                                Edit&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                            </Link>
                            <button onClick={(e, ses) => onSelectUserForDeletion(e, datum)} class="button is-small is-danger" type="button">
...
export default AdminStoreDetailForUserListMobile;
