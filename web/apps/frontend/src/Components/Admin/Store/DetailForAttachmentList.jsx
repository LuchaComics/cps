                ...
                <section class="section">
                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            {store && <div class="column has-text-right">
                                <Link to={`/admin/store/${id}/attachments/add`} class="button is-small is-success is-fullwidth-mobile" type="button">
                                ...
                                {store && <div class="container">
                                    <div class= "tabs is-medium is-size-7-mobile">
                                      <ul>
                                        ...
                                        <li class="is-active">
                                            <Link to={`/admin/store/${store.id}/attachments`}><b>Attachments</b></Link>
                                        </li>
                                        <li>
                                        ...
                                        <div class="container">
                                            <article class="message is-dark">
                                                <div class="message-body">
                                                    No attachments. <b><Link to={`/admin/store/${id}/attachments/add`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating a new attachment.
                                                </div>
                                            </article>
                                        </div>
                                    }
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/store/${id}/attachments/add`} class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add Attachment</Link>
                                        </div>
                                    </div>
