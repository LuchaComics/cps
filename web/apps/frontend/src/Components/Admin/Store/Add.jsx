...
import { faArrowLeft, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faIdCard, faAddressBook, faContactCard, faChartPie, faBuilding, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function AdminStoreAdd() {
    ...
    const onSubmitClick = (e) => {
        ...
        postStoreCreateAPI(store, onAdminStoreAddSuccess, onAdminStoreAddError, onAdminStoreAddDone, onUnauthorized);
    }
    ...
    function onAdminStoreAddSuccess(response){
        ...
        setTimeout(() => {
            ...
            console.log("onAdminStoreAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminStoreAddError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onAdminStoreAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
        ...
        <>
            ...
            <div class={`modal ${showCancelWarning ? 'is-active' : ''}`}>
                ...
                <div class="modal-card">
                    ...
                    <section class="modal-card-body">
                        Your store record will be cancelled and your work will be lost. This cannot be undone. Do you want to continue?
                    </section>
                    <footer class="modal-card-foot">
                        <Link class="button is-medium is-success" to={`/admin/stores`}>Yes</Link>
            ...
            <div class="container">
                <section class="section">
                    ...
                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Store</p>
