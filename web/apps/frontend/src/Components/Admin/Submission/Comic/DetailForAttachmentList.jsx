...
import { faTasks, faBookOpen, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faArrowRight, faTrashCan, faArrowUpRightFromSquare, faFile, faDownload } from '@fortawesome/free-solid-svg-icons'
...
import AdminComicSubmissionDetailForAttachmentListDesktop from "./DetailForAttachmentListDektop";
import AdminComicSubmissionDetailForAttachmentListMobile from "./DetailForAttachmentListMobile";


function AdminComicSubmissionDetailForAttachmentList() {
    ////
    //// URL Parameters.
    ////
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Online Comic Submission</p>
                            </div>
                            {submission && <div class="column has-text-right">
                                <Link to={`/admin/submissions/comic/${id}/attachments/add`} class="button is-small is-success is-fullwidth-mobile" type="button">
                                ...
                                {submission && <div class="container">
                                    <div class= "tabs is-medium is-size-7-mobile">
                                      <ul>
                                        ...
                                        <li class="is-active">
                                            <Link to={`/admin/submissions/comic/${id}/attachments`}><strong>Attachments</strong></Link>
                                        </li>
                                      </ul>
                                    </div>
                                        ...
                                        <div class="container">
                                            ...
                                            */}
                                            <div class="is-hidden-touch" >
                                                <AdminComicSubmissionDetailForAttachmentListDesktop
                                                    submissionID={id}
                                            ...
                                            */}
                                            <div class="is-fullwidth is-hidden-desktop">
                                                <AdminComicSubmissionDetailForAttachmentListMobile
                                                    submissionID={id}
                                                    listData={attachments}
                                                    setPageSize={setPageSize}
                                                    pageSize={pageSize}
                                        ...
                                        <div class="container">
                                            <article class="message is-dark">
                                                <div class="message-body">
                                                    No attachments. <b><Link to={`/admin/submissions/comic/${id}/attachments/add`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating a new attachment.
                                                </div>
                                            </article>
                                        </div>
                                    }
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/admin/submissions`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comic Submissions</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/submissions/comic/${id}/attachments/add`} class="button is-primary is-fullwidth-mobile">
...
export default AdminComicSubmissionDetailForAttachmentList;
