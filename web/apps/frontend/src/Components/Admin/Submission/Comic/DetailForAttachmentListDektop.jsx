...
function AdminComicSubmissionDetailForAttachmentListDesktop(props) {
                            ...
                            return <tr>
                                ...
                                <td class="is-actions-cell">
                                    <div class="buttons is-right">
                                        <Link to={`/admin/submissions/comic/${submissionID}/attachment/${attachment.id}`} class="button is-small is-primary" type="button">
                                            View
                                        </Link>
                                        <Link to={`/admin/submissions/comic/${submissionID}/attachment/${attachment.id}/edit`} class="button is-small is-warning" type="button">
                                            Edit
                                        </Link>
...
export default AdminComicSubmissionDetailForAttachmentListDesktop;
