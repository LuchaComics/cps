...
import { faTasks, faBookOpen, faTachometer, faPlus, faDownload, faArrowLeft, faArrowRight, faCheckCircle, faCheck, faGauge, faArrowUpRightFromSquare, faSearch, faFilter, faUsers  } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        <div class="container pb-6">
                            ...
                            <Link class="is-medium is-danger" to="/admin/submissions/comics/add/starred">Select from starred customers&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>&nbsp;&nbsp;<br /><br />
                            <Link class="is-medium is-danger" to="/admin/submissions/comics/add">Skip selecting a customer&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                        </div>
