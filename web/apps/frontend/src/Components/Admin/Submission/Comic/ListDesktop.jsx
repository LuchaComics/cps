...
function AdminComicSubmissionListDesktop(props) {
            ...
            <div class="table-wrapper has-mobile-cards">
                <table class="table is-fullwidth is-striped is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        ...
                        {listData && listData.results && listData.results.map(function(submission, i){
                            return <tr>
                                <td data-label="Store">
                                    {submission.storeId !== "000000000000000000000000" &&
                                      <Link to={`/admin/store/${submission.storeId}`} target="_blank" rel="noreferrer" class="is-small">
                                          {submission.storeName}&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                                      </Link>
                                    }
                                </td>
                                ...
                                <td data-label="Customer">
                                    {submission.customerId !== undefined && submission.customerId !== null && submission.customerId !== ""
                                        ?
                                        <>
                                            {submission.customerId !== "000000000000000000000000" && <Link to={`/customer/${submission.customerId}`} target="_blank" rel="noreferrer" class="is-small">
                                                {submission.customerFirstName}&nbsp;{submission.customerLastName}&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} />
                                            </Link>}
                                        </>
                                        :
                                        <>-</>
...
export default AdminComicSubmissionListDesktop;
