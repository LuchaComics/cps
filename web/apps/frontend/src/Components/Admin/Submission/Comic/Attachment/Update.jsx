...
import { faTasks, faBookOpen, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs, faEye, faArrowLeft, faFile } from '@fortawesome/free-solid-svg-icons'
...
function AdminSubmissionAttachmentUpdate() {
    ...
    function onAdminSubmissionAttachmentUpdateSuccess(response){
        ...
        setTimeout(() => {
            console.log("onAdminSubmissionAttachmentUpdateSuccess: Delayed for 2 seconds.");
            console.log("onAdminSubmissionAttachmentUpdateSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminSubmissionAttachmentUpdateError(apiErr) {
        ...
        setTimeout(() => {
            console.log("onAdminSubmissionAttachmentUpdateError: Delayed for 2 seconds.");
            console.log("onAdminSubmissionAttachmentUpdateError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminSubmissionAttachmentDetailError(apiErr) {
        ...
        setTopAlertStatus("danger");
        setTimeout(() => {
            console.log("onAdminSubmissionAttachmentDetailError: Delayed for 2 seconds.");
            console.log("onAdminSubmissionAttachmentDetailError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/admin/submissions/comic/${id}/attachment/${aid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faFile} />&nbsp;Attachment</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/submissions/comic/${id}/attachment/${aid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Attachment</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link to={`/admin/submissions/comic/${id}/attachment/${aid}`} class="button is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Attachment
                                            </Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <button class="button is-medium is-primary is-fullwidth-mobile" onClick={onSubmitClick}>
