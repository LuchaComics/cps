...
import { faTasks, faBook, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faArrowRight, faTrashCan, faArrowUpRightFromSquare, faFile, faDownload } from '@fortawesome/free-solid-svg-icons'
                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            {submission && <div class="column has-text-right">
                                {/* Mobile Specific */}
                                <Link to={`/admin/submissions/comic/${id}/attachments/add`} class="button is-small is-success is-fullwidth is-hidden-desktop" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;Add Attachment
                                </Link>
                                {/* Desktop Specific */}
                                <Link to={`/admin/submissions/comic/${id}/attachments/add`} class="button is-small is-success is-hidden-touch" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;Add Attachment
                                </Link>
                            </div>}
                        </div>
                                ...
                                {submission && <div class="container">
                                                ...
                                                <div class="table-wrapper has-mobile-cards">
                                                    <table class="table is-fullwidth is-striped is-hoverable is-fullwidth">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            {attachments && attachments && attachments.map(function(attachment, i){
                                                                return <tr>
                                                                    ...
                                                                    <td class="is-actions-cell">
                                                                        <div class="buttons is-right">
                                                                            <Link to={`/admin/submissions/comic/${submission.id}/attachment/${attachment.id}`} class="button is-small is-primary" type="button">
                                                                                View
                                                                            </Link>
                                                                            <Link to={`/admin/submissions/comic/${submission.id}/attachment/${attachment.id}/edit`} class="button is-small is-warning" type="button">
                                                                                Edit
                                                                            </Link>
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-hidden-touch" to={`/admin/submissions`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/submissions/comic/${id}/attachments/add`} class="button is-primary is-hidden-touch"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add Attachment</Link>
                                            <Link to={`/admin/submissions/comic/${id}/attachments/add`} class="button is-primary is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add Attachment</Link>
                                        </div>
                                    </div>
