                            ...
                            <>
                                {currentUser && <div class="container">
                                    ...
                                    <div class="columns">
                                        ...
                                        {currentUser.hasShippingAddress &&<div class="column">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-medium is-fullwidth-mobile" to={"/dashboard"}>
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Dashboard
                                            </Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={"/account/update"} class="button is-medium is-primary is-fullwidth-mobile">
