...
//     const axios = getCustomAxios();
//     axios.get(CPS_CREDIT_COMPLETE_STRIPE_CHECKOUT_SESSION_API_ENDPOINT.replace("{sessionID}", sessionID)).then((successResponse) => {
//         const responseData = successResponse.data;
//
//         // Snake-case from API to camel-case for React.
//         const data = camelizeKeys(responseData);
...
//     const axios = getCustomAxios();
//
//     let aURL = CPS_CREDIT_PAYMENT_PROCESSOR_STRIPE_INVOICES_API_ENDPOINT.replace("{userID}",userID).replace("{cursor}",cursor).replace("{pageSize}",pageSize);
//
...
//         offer_id: offerId,
//     };
//     axios.post(CPS_CREDIT_PAYMENT_PROCESSOR_SEND_SUBSCRIPTION_REQUEST_EMAIL_API_ENDPOINT, data).then((successResponse) => {
//         const responseData = successResponse.data;
//
//         // Snake-case from API to camel-case for React.
//         const data = camelizeKeys(responseData);
