...
export function postUserCreateAPI(data, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    ...
    if (decamelizedData.store_id !== undefined && decamelizedData.store_id !== null && decamelizedData.store_id !== "" && decamelizedData.store_id.length < 14) {
...
export function getUserDetailAPI(customerID, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
...
export function postUserCreateCommentOperationAPI(userID, content, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
    const data = {
        user_id: userID,
        content: content,
...
export function postUserStarOperationAPI(userID, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
    const data = {
        user_id: userID,
    };
    axios.post(CPS_USER_STAR_OPERATION_API_ENDPOINT, data).then((successResponse) => {
        const responseData = successResponse.data;
