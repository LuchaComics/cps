...
import { faArrowUpRightFromSquare, faTrash, faHandHolding, faRepeat, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faDumbbell, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs } from '@fortawesome/free-solid-svg-icons'
                        ...
                        <div class={`modal ${selectedOfferForDeletion !== null ? 'is-active' : ''}`}>
                            ...
                            <div class="modal-card">
                                ...
                                <section class="modal-card-body">
                                    You cannot delete here. Deletions are handled in <Link to="https://stripe.com"  target="_blank" rel="noreferrer">Stripe, Inc.&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link>, please login and delete the product and this backend will automatically delete.
                                </section>
                                <footer class="modal-card-foot">
                                    {/*<button class="button is-success" onClick={onDeleteConfirmButtonClick}>Confirm</button>*/}
                                    <button class="button" onClick={(e, ses) => setSelectedOfferForDeletion(null)}>OK</button>
                                </footer>
                            </div>
                        </div>
                    </nav>
                            ...
                            <>
                                {datum && <div class="container" key={datum.id}>
                                    ...
                                    */}
                                    ...
                                    <DataDisplayRowSelect
                                        label="Service Type"
                                        selectedValue={datum.serviceType}
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/admin/offers`}>
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Offers
                                            </Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/offer/${id}/update`} class="button is-warning is-fullwidth-mobile">
