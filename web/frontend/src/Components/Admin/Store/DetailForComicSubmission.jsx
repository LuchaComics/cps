                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            <div class="column has-text-right">
                                <Link to={`/admin/submissions/comics/add/search`} target="_blank" rel="noreferrer" class="button is-small is-success is-fullwidth-mobile" type="button">
                        ...
                        {isFetching
                            ...
                            <>
                                {store && <div class="container">
                                    ...
                                    <p class="subtitle is-6 pt-4"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Online Comic Submissions</p>
                                    <hr />
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/submissions/comics/add/search`} target="_blank" rel="noreferrer" class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;CPS&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link>
                                        </div>
                                    </div>
