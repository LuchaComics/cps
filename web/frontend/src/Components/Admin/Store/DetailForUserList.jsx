                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            <div class="column has-text-right">
                                <Link to={`/admin/users/add?store_id=${id}&store_name=${store.name}`} class="button is-small is-success is-fullwidth-mobile" type="button">
                                ...
                                {store && <div class="container">
                                        ...
                                        <div class="container">
                                            <article class="message is-dark">
                                                <div class="message-body">
                                                    No users. <b><Link to={`/admin/users/add?store_id=${id}&store_name=${store.name}`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating a new user.
                                                </div>
                                            </article>
                                        </div>
                                    }
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/users/add?store_id=${id}&store_name=${store.name}`} class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add User</Link>
                                        </div>
                                    </div>
