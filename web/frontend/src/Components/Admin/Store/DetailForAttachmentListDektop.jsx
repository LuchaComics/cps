...
function AdminStoreDetailForAttachmentListDesktop(props) {
    const { storeID, listData, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectAttachmentForDeletion } = props;
    return (
        <div class="b-table">
                            ...
                            return <tr>
                                ...
                                <td class="is-actions-cell">
                                    <div class="buttons is-right">
                                        <Link to={`/admin/store/${storeID}/attachment/${attachment.id}`} class="button is-small is-primary" type="button">
                                            View
                                        </Link>
                                        <Link to={`/admin/store/${storeID}/attachment/${attachment.id}/edit`} class="button is-small is-warning" type="button">
                                            Edit
                                        </Link>
