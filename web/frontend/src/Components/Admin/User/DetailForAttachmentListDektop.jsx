                            ...
                            return <tr>
                                ...
                                <td class="is-actions-cell">
                                    <div class="buttons is-right">
                                        <Link to={`/admin/user/${userID}/attachment/${attachment.id}`} class="button is-small is-primary" type="button">
                                            View
                                        </Link>
                                        <Link to={`/admin/user/${userID}/attachment/${attachment.id}/edit`} class="button is-small is-warning" type="button">
                                            Edit
                                        </Link>
