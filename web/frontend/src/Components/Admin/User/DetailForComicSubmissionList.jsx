                                ...
                                {user && <div class="container">
                                            ...
                                            */}
                                            <div class="is-hidden-touch" >
                                                <AdminUserDetailForComicSubmissionListDesktop
                                                    ...
                                                    onSelectComicSubmissionForDeletion={onSelectComicSubmissionForDeletion}
                                                />
                                            </div>
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/admin/users`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Users</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/submissions/pick-type-for-add?user_id=${id}&user_name=${user.name}`} class="button is-primary is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;CPS
                                            </Link>
                                        </div>
                                    </div>
