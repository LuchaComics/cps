...
function AdminUserDetailForCommentList() {
    ...
    const onSubmitClick = (e) => {
        ...
        setErrors(null);
        postUserCreateCommentOperationAPI(id, content, onUserUpdateSuccess, onUserUpdateError, onUserUpdateDone, onUnauthorized);
    }
                                ...
                                {user && <div class="container">
                                    ...
                                    <div class="columns pt-4">
                                        <div class="column is-half">
                                            <Link to={`/admin/users`} class="button is-fullwidth-mobile">
