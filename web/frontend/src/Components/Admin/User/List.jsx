...
import { faArrowLeft, faUsers, faTachometer, faEye, faPencil, faTrashCan, faPlus, faGauge, faArrowRight, faTable, faArrowUpRightFromSquare, faRefresh, faFilter, faFilterCircleXmark, faSearch } from '@fortawesome/free-solid-svg-icons';
...
function AdminUserList() {
    ...
    const [temporarySearchText, setTemporarySearchText] = useRecoilState(userFilterTemporarySearchTextState); // Searching - The search field value as your writes their query.
    const [actualSearchText, setActualSearchText] = useRecoilState(userFilterActualSearchTextState);          // Searching - The actual search query value to submit to the API.
    ...
    const [createdAtGTE, setCreatedAtGTE] = useRecoilState(userFilterJoinedAfterState);                       // Filtering
                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            <div className="column has-text-right is-hidden-desktop is-hidden-tablet">
                                ...
                                &nbsp;
                                <Link to={`/admin/users/add`} class="button is-small is-primary is-fullwidth" type="button">
