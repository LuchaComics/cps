...
import { faTrashCan, faCog,faStar, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs } from '@fortawesome/free-solid-svg-icons'
import { useRecoilState } from 'recoil';
import { useParams } from 'react-router-dom';

import useLocalStorage from "../../../Hooks/useLocalStorage";
import { getUserDetailAPI, postUserStarOperationAPI, deleteUserAPI } from "../../../API/user";
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/users`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Users</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        {user && <div class="columns">
                            ...
                            <div class="column has-text-right">
                                <Link to={`/admin/submissions/pick-type-for-add?user_id=${id}&user_name=${user.name}`} class="button is-small is-success is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;CPS
                                </Link>&nbsp;&nbsp;
                                <Link to={`/admin/user/${user.id}/edit`} class="button is-small is-warning is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit
                                </Link>&nbsp;&nbsp;
                                <button onClick={(e, ses) => onSelectUserForDeletion(e, user)} class="button is-small is-danger is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faTrashCan} />&nbsp;Delete
                                </button>&nbsp;&nbsp;
                                {user.isStarred
                                    ?
                                    <Link class="button is-small is-fullwidth-mobile has-text-warning-dark has-background-warning" type="button" onClick={onStarClick}>
                                        <FontAwesomeIcon className="mdi" icon={faStar} />&nbsp;Starred
                                    </Link>
                                    :
                                    <Link class="button is-small is-fullwidth-mobile" type="button" onClick={onStarClick}>
                                        <FontAwesomeIcon className="mdi" icon={faStar} /><span class="is-hidden-desktop is-hidden-tablet">&nbsp;Unstarred</span>
                                    </Link>
                                }
                            </div>
                        </div>}
                                ...
                                {user && <div class="container">
                                    <div class= "tabs is-medium is-size-7-mobile">
                                      <ul>
                                        ...
                                        <li>
                                            <Link to={`/admin/user/${user.id}/credits`}>Credits</Link>
                                        </li>
                                      </ul>
                                    </div>
                                    ...
                                    {storeSelectOptions && storeSelectOptions.length > 0 && <FormTextOptionRow
                                        label="Store"
                                    ...
                                    <div class="columns">
                                        ...
                                        {user.hasShippingAddress &&<div class="column">
                                    ...
                                    */}
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/admin/users`}>
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Users
                                            </Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/user/${id}/edit`} class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                        </div>
                                    </div>
