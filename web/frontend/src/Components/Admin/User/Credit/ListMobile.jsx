...
*/
function AdminUserCreditListMobile(props) {
        ...
        <>
            {listData && listData.results && listData.results.map(function(datum, i){
                return <div class="mb-5">
                    {i !== 0 && <hr />}
                    <strong>Business Function:</strong>&nbsp;{CREDIT_BUSINESS_FUNCTION_STATES[datum.businessFunction]}
                    <br />
                    <br />
                    ...
                    <div class="is-hidden-mobile pt-2">
                        <div className="buttons is-right">
                            <Link to={`/admin/user/${datum.userId}/credit/${datum.id}`} class="button is-small is-primary" type="button">
                                View&nbsp;<FontAwesomeIcon className="fas" icon={faChevronRight} />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div class="is-hidden-tablet pt-2">
                        <div class="columns is-mobile">
                            <div class="column">
                                <Link to={`/admin/user/${datum.userId}/credit/${datum.id}`} class="button is-small is-primary is-fullwidth" type="button">
                                    View&nbsp;<FontAwesomeIcon className="fas" icon={faChevronRight} />
                                </Link>
                            </div>
                        </div>
...
export default AdminUserCreditListMobile;
