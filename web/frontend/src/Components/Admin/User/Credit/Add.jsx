...
import { faEye, faArrowLeft, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faIdCard, faAddressBook, faContactCard, faChartPie, faBuilding, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function AdminUserCreditAdd() {
    ...
    const onSubmitClick = (e) => {
        ...
        postCreditCreateAPI(credit, onAdminUserCreditAddSuccess, onAdminUserCreditAddError, onAdminUserCreditAddDone, onUnauthorized);
    }
    ...
    function onAdminUserCreditAddSuccess(){
        ...
        setTimeout(() => {
            ...
            console.log("onAdminUserCreditAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminUserCreditAddError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onAdminUserCreditAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/admin/user/${id}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Credits)</Link></li>
                    ...
                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Credit</p>
                            ...
                            <>
                                ...
                                <div class="container">
                                    ...
                                    <FormSelectField
                                        ...
                                        onChange={(e)=>setNumberOfCredits(parseInt(e.target.value))}
                                        options={NUMBER_OF_CREDITS_WITH_EMPTY_OPTIONS}
                                    />

                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-medium is-fullwidth-mobile" to={`/admin/user/${id}/credits`}><FontAwesomeIcon className="fas" icon={faTimesCircle} />&nbsp;Cancel</Link>
                                        </div>
