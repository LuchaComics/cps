...
import { faArrowLeft, faTasks, faBook, faTachometer, faPlus, faTimesCircle, faCheckCircle, faGauge, faUsers, faEye, faCube, faMagnifyingGlass, faBalanceScale, faUser, faCogs, faBookOpen, faNewspaper, faArrowRight } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                    ...
                    {userName === null
                        ...
                        <>
                            ...
                            <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                                <ul>
                                    <li class=""><Link to={`/admin/user/${userID}/sub`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Comic Submissions)</Link></li>
                                </ul>
                            </nav>
                        </>
                    }
                    ...
                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Submission</p>
                        <div class="container">
                            ...
                            <section class="hero is-medium is-link">
                              <div class="hero-body">
                                ...
                                <p class="subtitle">
                                  ...
                                  {userName === null
                                      ?
                                      <Link to={`/admin/submissions/comics/add/search`}>Select&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                                      :
                                      <Link to={`/admin/submissions/comics/add?user_id=${userID}`}>Select&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                                  }
                                </p>
                              </div>
                            </section>
