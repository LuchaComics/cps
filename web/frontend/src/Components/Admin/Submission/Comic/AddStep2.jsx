...
import { faArrowLeft, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faGauge, faUsers, faEye, faBookOpen, faBook, faMagnifyingGlass, faBalanceScale, faUser, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function AdminComicSubmissionAddStep2() {
    ...
    const [cpsExclusiveEditionDetail, setCPSExclusiveEditionDetail] = useState("");
                        ...
                        <>
                            ...
                            <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                                <ul>
                                    ...
                                    <li class=""><Link to={`/admin/user/${customerID}/sub`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Comic Submissions)</Link></li>
                                    <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New</Link></li>
                                </ul>
                            </nav>
                            ...
                            <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                                <ul>
                                    <li class=""><Link to={`/admin/user/${customerID}/sub`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Online Comic Submissions)</Link></li>
                                </ul>
                            </nav>
                        </>
                    }
                            ...
                            <div class="modal-card">
                                ...
                                <footer class="modal-card-foot">
                                    {customerName === null
                                        ...
                                        :
                                        <Link class="button is-medium is-success" to={`/admin/user/${customerID}/sub`}>Yes</Link>
                                    }
                            ...
                            <>
                                ...
                                <div class="container">
                                    ...
                                    <FormSelectField
                                        ...
                                        disabled={(orgID !== undefined && orgID !== "" && orgID !== null) || storeSelectOptions.length === 0}
                                    />
                                    <FormSelectField
                                        label="Service Type"
                                        name="serviceType"
