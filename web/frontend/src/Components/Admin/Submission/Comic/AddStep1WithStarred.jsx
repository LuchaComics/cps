...
import { faTasks, faBookOpen, faTachometer, faPlus, faDownload, faArrowLeft, faTable, faCheckCircle, faCheck, faGauge, faUsers, faArrowUpRightFromSquare, faArrowRight } from '@fortawesome/free-solid-svg-icons'
...
function AdminComicSubmissionAddStep1WithStarredCustomer() {
    ////
    //// Global state.
    ////
                    ...
                    <nav class="box">
                                    ...
                                    {customers && customers.results && customers.results.length > 0
                                                ...
                                                return <div class="column is-one-quarter" key={customer.id}>
                                                    <article class="message is-primary">
                                                        <div class="message-body">
                                                            <p>
                                                                <Link to={`/admin/user/${customer.id}`} target="_blank" rel="noreferrer">
                                                            ...
                                                            <br />
                                                            <Link class="button is-medium is-primary" to={`/admin/submissions/comics/add?user_id=${customer.id}`}>
                                        ...
                                        <section class="hero is-medium has-background-white-ter">
                                          <div class="hero-body">
                                            ...
                                            <p class="subtitle">
                                                No results were found in the search. <Link class="is-medium is-warning" to="/admin/users/add" target="_blank" rel="noreferrer">Click here&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link> to create a new customer or <Link class="is-medium is-danger" to="/admin/submissions/comics/add">click here&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link> to continue without a customer.
                                            </p>
                                          </div>
                                        </section>
                                    }
                        ...
                        <div class="columns pt-5">
                            <div class="column is-half">
                                <Link class="button is-medium is-fullwidth-mobile" to="/admin/submissions/comics/add/search"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                            </div>
...
export default AdminComicSubmissionAddStep1WithStarredCustomer;
