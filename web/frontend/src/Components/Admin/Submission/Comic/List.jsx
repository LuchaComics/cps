...
import { faArrowLeft, faTasks, faTachometer, faEye, faPencil, faTrashCan, faPlus, faGauge, faArrowRight, faTable, faBookOpen, faNewspaper, faArrowUpRightFromSquare, faRefresh, faFilter, faFilterCircleXmark, faSearch } from '@fortawesome/free-solid-svg-icons';
import { useRecoilState } from 'recoil';

import { getComicSubmissionListAPI, deleteComicSubmissionAPI } from "../../../../API/ComicSubmission";
import {
    topAlertMessageState, topAlertStatusState, currentUserState,
...
function AdminComicSubmissionList() {
    ...
    const [temporarySearchText, setTemporarySearchText] = useRecoilState(submissionFilterTemporarySearchTextState); // Searching - The search field value as your writes their query.
    const [actualSearchText, setActualSearchText] = useRecoilState(submissionFilterActualSearchTextState);
    const [storeID, setStoreID] = useRecoilState(submissionFilterStoreIDState);
    const [storeName, setStoreName] = useRecoilState(submissionFilterStoreNameState);
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Comics</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/submissions`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Submissions</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        <div class="columns">
                            <div class="column is-8">
                                {
                                  ...
                                  ?
                                  <h1 class="title is-4"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Online Comic Submissions for: {storeName}</h1>
                                  :
                                  <h1 class="title is-4"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Online Comic Submissions</h1>
                                }
                            </div>

                            {/* Mobile only */}
                            <div className="column has-text-right is-hidden-desktop is-hidden-tablet">
                                <button onClick={()=>fetchList(currentCursor, pageSize, actualSearchText, storeID, status)} class="button is-small is-info is-fullwidth" type="button">
                                ...
                                &nbsp;
                                <Link to={`/admin/submissions/comics/add/search`} class="button is-small is-primary is-fullwidth" type="button">
                            ...
                            <div className="column has-text-right is-hidden-mobile">
                                <button onClick={()=>fetchList(currentCursor, pageSize, actualSearchText, storeID, status)} class="button is-small is-info" type="button">
                        ...
                        <div class="columns pt-4">
                            <div class="column is-half">
                                <Link to={`/admin/dashboard`} class="button is-medium is-fullwidth-mobile">
