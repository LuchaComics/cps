...
import { faTasks, faBookOpen, faTachometer, faPlus, faDownload, faArrowLeft, faCheckCircle, faCheck, faGauge, faUsers, faEye } from '@fortawesome/free-solid-svg-icons'
        ...
        <>
            <div class="container">
                <section class="section">
                        ...
                        <>
                            ...
                            <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                                <ul>
                                    ...
                                    <li class=""><Link to={`/admin/customer/${customerID}/sub`} aria-current="page"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Online Comic Submissions</Link></li>
                                    <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New</Link></li>
                                </ul>
                            </nav>
                            ...
                            <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                                <ul>
                                    <li class=""><Link to={`/admin/customer/${customerID}/sub`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Comic Submissions)</Link></li>
                                </ul>
                            </nav>
                        </>
                     }
                    ...
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Online Comic Submission (Confirmation)</p>
                                    ...
                                    <article>
                                            ...
                                            <div class="hero-body">
                                                <p class="subtitle">
                                                    <div class="has-text-centered">
                                                        <a href={submission.findingsFormObjectUrl} target="_blank" rel="noreferrer" class="button is-large is-success is-fullwidth-mobile">
                                                            <FontAwesomeIcon className="fas" icon={faDownload} />&nbsp;Findings Form
                                                         </a>
                                                    </div>
                                                </p>
                                            </div>
                                        ...
                                        <section class="hero has-background-white-ter">
                                            <div class="hero-body">
                                                <p class="subtitle">
                                                    <div class="has-text-centered">
                                                        <a href={submission.labelObjectUrl} target="_blank" rel="noreferrer" class="button is-large is-success is-fullwidth-mobile">
                                                           <FontAwesomeIcon className="fas" icon={faDownload} />&nbsp;Label
                                                        </a>
                                                    </div>
                                                </p>
                                            </div>
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        {customerName === null
                                            ...
                                            <div class="column is-half has-text-right">
                                                <Link to={`/admin/submissions/comics`} class="button is-medium is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to List</Link>
                                            </div>
                                            :
                                            <div class="column is-half has-text-right">
                                                <Link to={`/admin/customer/${customerID}/sub`} class="button is-medium is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Customer</Link>
                                            </div>
                                        }
                                    </div>
                                </div>
