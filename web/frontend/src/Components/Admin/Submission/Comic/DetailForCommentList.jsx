...
import { faTasks, faTachometer, faPlus, faEye, faArrowLeft, faCheckCircle, faPencil, faGauge, faBookOpen, faMagnifyingGlass, faBalanceScale, faUser, faArrowUpRightFromSquare, faComments } from '@fortawesome/free-solid-svg-icons'
...
function AdminComicSubmissionDetailForCommentList() {
    ...
    const onSubmitClick = (e) => {
        ...
        setErrors(null);
        setFetching(true);
        postComicSubmissionCreateCommentOperationAPI(id, content, onComicSubmissionUpdateSuccess, onComicSubmissionUpdateError, onComicSubmissionUpdateDone, onUnauthorized);
    }
                                ...
                                {submission && <div class="container">
                                    ...
                                    <div class="columns pt-4">
                                        <div class="column is-half">
                                            <Link to={`/admin/submissions/comics`} class="button is-medium is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comic Submissions</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <button onClick={onSubmitClick} class="button is-medium is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Add Comment</button>
                                        </div>
                                    </div>
