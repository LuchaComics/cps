...
import { faTasks, faTachometer, faPlus, faEye, faArrowLeft, faCheckCircle, faPencil, faGauge, faBookOpen, faMagnifyingGlass, faBalanceScale, faUser, faArrowUpRightFromSquare, faDownload, faFile } from '@fortawesome/free-solid-svg-icons'
                        ...
                        {isFetching
                            ...
                            <>
                                {submission && <div class="container">
                                    ...
                                    <hr />
                                    <p class="pb-4 has-text-grey">Click the following "Download ..." button to start downloading a copy of the file submission in PDF file format to your computer.</p>
