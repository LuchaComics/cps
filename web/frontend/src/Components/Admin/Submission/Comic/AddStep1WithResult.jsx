                                            ...
                                            {users.results.map(function(user, i){
                                                return <div class="column is-one-quarter" key={user.id}>
                                                    <span className="has-text-grey-light is-size-7">
                                                        User found via <a href={`/admin/store/${user.storeId}`} target="_blank" rel="noreferrer">{user.storeName}&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></a>
                                                    </span>
