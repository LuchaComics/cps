...
import { faTasks, faTachometer, faPlus, faEye, faArrowLeft, faCheckCircle, faPencil, faGauge, faBookOpen, faMagnifyingGlass, faBalanceScale, faUser, faArrowUpRightFromSquare, faArrowRight } from '@fortawesome/free-solid-svg-icons'
...
function AdminComicSubmissionDetailForCustomer() {
    ...
    function onComicSubmissionDetailSuccess(response){
        ...
        if (response.customerId !== undefined && response.customerId !== null && response.customerId !== "" && response.customerId !== "000000000000000000000000") {
            setFetching(true);
            getUserDetailAPI(
                response.customerId,
                onUserDetailSuccess,
                        ...
                        {isFetching
                            ...
                            <>
                                {submission && <div class="container">
                                    ...
                                    {submission.customerId !== "000000000000000000000000" && user !== undefined && user !== null && user !== ""
                                        ?
                                        <>
                                            <p class="subtitle is-6 pt-4"><FontAwesomeIcon className="fas" icon={faUser} />&nbsp;Customer</p>
                                            <hr />
                                            <p class="pb-5"><Link to={`/admin/user/${submission.customerId}`} target="_blank" rel="noreferrer">Click here&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link> to view the customer.</p>
                                            ...
                                            />
                                            {user.howDidYouHearAboutUs === 1 && <FormRowText
                                            ...
                                            <div class="columns pt-5">
                                                <div class="column is-half">
                                                    <Link to={`/admin/submissions/comics`} class="button is-medium is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                                </div>
                                                <div class="column is-half has-text-right">
                                                    <Link onClick={(e)=>setShowCustomerEditOptions(true)} class="button is-medium is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit Customer</Link>
                                                </div>
                                            </div>
                                        </>
                                        :
