                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to="/admin/submissions" aria-current="page"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Online Submissions</Link></li>
                            <li class=""><Link to="/admin/submissions/comics" aria-current="page"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Comics</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/submissions/comics`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comics</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        {submission && <div class="columns">
                            <div class="column">
                                <p class="title is-4">
                                    <FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Online Comic Submission
                                </p>
                            </div>
                            <div class="column has-text-right">
                                <Link to={`/admin/submissions/comic/${submission.id}/edit`} class="button is-small is-warning is-fullwidth-mobile" type="button">
                        ...
                        {isFetching
                            ...
                            :
                            <>
                                {submission !== undefined && submission !== null && submission !== "" && <div class="container">
                                    ...
                                    <p class="subtitle is-6 pt-4"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Comic Book Information</p>
                                    <hr />
                                    ...
                                    {submission.serviceType !== SERVICE_TYPE_CPS_CAPSULE_INDIE_MINT_GEM &&
                                        <>
                                            ...
                                            {submission.gradingScale === 2 && <DataDisplayRowSelect
                                            ...
                                            {submission.gradingScale === 3 && <DataDisplayRowSelect
                                    ...
                                    <div class="columns pt-4">
                                        <div class="column is-half">
                                            <Link to={`/admin/submissions/comics`} class="button is-medium is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comic Submissions
                                            </Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/submissions/comic/${id}/edit`} class="button is-medium is-primary is-fullwidth-mobile">
