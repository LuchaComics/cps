            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/admin/registry`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Registry</Link></li>
                        </ul>
                    </nav>
                        ...
                        {isFetching
                            ...
                            <>
                                {submission && <div class="container">
                                    ...
                                    {submission.issueCoverYear !== 0 && submission.issueCoverYear !== 1 && <FormTextOptionRow
                                    ...
                                    {submission.publisherName === "Other" && <FormRowText
                                    ...
                                    {submission && submission.gradingScale === 1 && <FormTextOptionRow
                                    ...
                                    {submission && submission.gradingScale === 2 && <FormTextOptionRow
                                    ...
                                    {submission && submission.gradingScale === 3 && <FormTextOptionRow
                                    ...
                                    <div class="columns pt-4">
                                        <div class="column is-half">
                                            <Link to={`/admin/registry`} class="button is-medium is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Search
                                            </Link>
                                        </div>
