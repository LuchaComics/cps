...
import { faExclamationTriangle, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faArrowRight, faArrowUpRightFromSquare } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        */}
                        ...
                        <p class="is-italic">Please note: the comic book store owner or manager must fill out registration this form</p>
                        <br />
                        ...
                        {!isFetching && <div class="container">
                            <p class="subtitle is-3"><u><b>Your Information</b></u></p>
                            ...
                            <p class="subtitle is-3"><u><b>Contact Information</b></u></p>
                            ...
                            <div class="columns">
                                <div class="column">
                                    ...
                                    {hasShippingAddress
                                        ? <p class="subtitle is-3"><u><b>Billing Address</b></u></p>
                                        : <p class="subtitle is-3"><u><b>Address</b></u></p>
                                    }
                                    </p>
                                    <FormCountryField
                                ...
                                {hasShippingAddress &&<div class="column">
                                    <p class="subtitle is-3"><u><b>Shipping Address</b></u></p>
                            ...
                            <p class="subtitle is-3"><u><b>About Your Store</b></u></p>
                            ...
                            <FormCheckboxField
                                label={<>I agree to <Link to="/terms" target="_blank" rel="noreferrer">terms of service&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link> and <Link to="/privacy" target="_blank" rel="noreferrer">privacy policy&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link></>}
                                name="agreeTOS"
                                checked={agreeTOS}
                            ...
                            <div class="columns">
                                <div class="column is-half">
                                    <Link to={`/login`} class="button is-medium is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                </div>
                                <div class="column is-half has-text-right">
                                    <button class="button is-medium is-primary is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Register</button>
                                </div>
                            </div>
                        </div>}
                    </nav>
