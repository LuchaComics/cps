                                ...
                                <div class="is-rounded column is-two-third-tablet">
                                    <article class="message is-primary">
                                      <div class="message-body">
                                            <h1 className="title is-4 has-text-centered has-text-success"><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Email Verified</h1>
                                            <FormErrorBox errors={errors} />
                                            <p>Thank you for verifying. Your application has been forward to CPS staff, and will be processed within 1 business day.</p>
                                            <p>
                                                <br />
