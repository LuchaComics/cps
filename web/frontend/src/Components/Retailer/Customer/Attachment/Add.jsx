...
function RetailerCustomerAttachmentAdd() {
    ////
    //// URL Parameters.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        postAttachmentCreateAPI(
            formData,
            onRetailerCustomerAttachmentAddSuccess,
            onRetailerCustomerAttachmentAddError,
            onRetailerCustomerAttachmentAddDone,
            onUnauthorized
        );
    ...
    function onRetailerCustomerAttachmentAddSuccess(response){
        // For debugging purposes only.
        console.log("onRetailerCustomerAttachmentAddSuccess: Starting...");
        ...
        setTimeout(() => {
            ...
            console.log("onRetailerCustomerAttachmentAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onRetailerCustomerAttachmentAddError(apiErr) {
        console.log("onRetailerCustomerAttachmentAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onRetailerCustomerAttachmentAddError: Delayed for 2 seconds.");
            console.log("onRetailerCustomerAttachmentAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onRetailerCustomerAttachmentAddDone() {
        console.log("onRetailerCustomerAttachmentAddDone: Starting...");
        setFetching(false);
    }
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/customer/${id}/attachments`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Attachments)</Link></li>
                        </ul>
                    </nav>
                                ...
                                <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link to={`/customer/${id}/attachments`} class="button is-hidden-touch"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                            <Link to={`/customer/${id}/attachments`} class="button is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                        </div>
...
export default RetailerCustomerAttachmentAdd;
