...
*/
function RetailerCustomerDetailForAttachmentMobile(props) {
    const { userID, listData, setPageSize, pageSize, previousCursors, onPreviousClicked, onNextClicked, onSelectAttachmentForDeletion } = props;
    return (
        <>
                ...
                return <div class="mb-5">
                    ...
                    <div class="is-hidden-mobile pt-2">
                        <div className="buttons is-right">
                            <Link to={`/customer/${datum.userId}/attachment/${datum.id}`} class="button is-small is-primary" type="button">
                                View
                            </Link>
                            <Link to={`/customer/${datum.userId}/attachment/${datum.id}/edit`} class="button is-small is-warning" type="button">
                                Edit
                            </Link>
                    ...
                    <div class="is-hidden-tablet pt-2">
                        <div class="columns is-mobile">
                            <div class="column">
                                <Link to={`/customer/${userID}/attachment/${datum.id}`} class="button is-small is-primary is-fullwidth" type="button">
                                    View
                                </Link>
                            </div>
                            <div class="column">
                                <Link to={`/customer/${userID}/attachment/${datum.id}/edit`} class="button is-small is-warning is-fullwidth" type="button">
                                    Edit
                                </Link>
                            </div>
                            <div class="column">
...
export default RetailerCustomerDetailForAttachmentMobile;
