                    ...
                    <nav class="box">
                        <div class="columns">
                            ...
                            {customer && <div class="column has-text-right">
                                <Link to={`/customer/${id}/attachments/add`} class="button is-small is-primary is-fullwidth-mobile" type="button">
                                ...
                                {customer && <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link to={`/customer/${id}/attachments/add`} class="button is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Attachment</Link>
                                        </div>
                                    </div>
