                                ...
                                {submission && <div class="container">
                                    ...
                                    {submission.customerId !== "000000000000000000000000" && user !== undefined && user !== null && user !== ""
                                        ...
                                        <>
                                            ...
                                            <hr />
                                            <p class="pb-5"><Link to={`/customer/${submission.customerId}`} target="_blank" rel="noreferrer">Click here&nbsp;<FontAwesomeIcon className="fas" icon={faArrowUpRightFromSquare} /></Link> to view the customer.</p>
                                            ...
                                            <div class="columns pt-5">
                                                <div class="column is-half">
                                                    <Link to={`/submissions/comics`} class="button is-medium is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comic Submissions</Link>
                                                </div>
