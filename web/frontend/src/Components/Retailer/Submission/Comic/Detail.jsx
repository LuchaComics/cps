...
import { faShoppingCart, faTasks, faTachometer, faPlus, faEye, faArrowLeft, faCheckCircle, faPencil, faGauge, faBook, faBookOpen, faMagnifyingGlass, faBalanceScale, faUser, faArrowUpRightFromSquare, faDownload, faCogs } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to="/submissions" aria-current="page"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Online Submissions</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to={`/submissions/comics`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comics</Link></li>
                        </ul>
                    </nav>

                    {/* Page */}
                    <nav class="box">
                        {submission && <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Comic Submission</p>
                            </div>
                            <div class="column has-text-right">
                                <Link to={`/submissions/comic/${submission.id}/edit`} class="button is-small is-warning is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit Comic Submission
                                </Link>
                            </div>
                        </div>}
                        ...
                        {isFetching
                            ...
                            <>
                                {submission && <div class="container">
                                    ...
                                    {submission.primaryLabelDetails === 1 && <FormRowText
                                    ...
                                    {submission.issueCoverYear !== 0 && submission.issueCoverYear !== 1 && <DataDisplayRowSelect
                                    ...
                                    {submission.publisherName === 1 && <FormRowText
                                    ...
                                    {submission.isVariantCover === true && <FormRowText
                                    ...
                                    {submission.serviceType !== SERVICE_TYPE_CPS_CAPSULE_INDIE_MINT_GEM &&
                                        ...
                                        {submission && submission.gradingScale === 2 && <DataDisplayRowSelect
                                        ...
                                        {submission && submission.gradingScale === 3 && <DataDisplayRowSelect
                                    ...
                                    {submission.paymentProcessor > 0 && <>
                                        <p class="subtitle is-6"><FontAwesomeIcon className="fas" icon={faShoppingCart} />&nbsp;Purchase Details</p>
                                        <hr />
                                    ...
                                    <div class="columns pt-4">
                                        <div class="column is-half">
                                            <Link to={`/submissions/comics`} class="button is-medium is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Comic Submissions
                                            </Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/submissions/comic/${id}/edit`} class="button is-medium is-primary is-fullwidth-mobile">
                                                <FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit Comic Submission
                                            </Link>
                                        </div>
                                    </div>
                                </div>}
...
export default RetailerComicSubmissionDetail;
