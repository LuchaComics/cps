...
import { faArrowLeft, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faGauge, faUsers, faEye, faBookOpen, faMagnifyingGlass, faBalanceScale, faUser, faArrowUpRightFromSquare, faCog } from '@fortawesome/free-solid-svg-icons'
...
function RetailerComicSubmissionAddStep2() {
    ...
    const onSubmitClick = (e) => {
        ...
        const submission = {
            ...
            showsSignsOfTamperingOrRestoration: parseInt(showsSignsOfTamperingOrRestoration), // 2=No
    ...
    const cpsPercentageGradeFilteredOptions = cpsPercentageGradeFilterOptions(CPS_PERCENTAGE_GRADE_WITH_EMPTY_OPTIONS, currentUser.storeLevel);
    const overallNumberGradeFilteredOptions = overallNumberGradeFilterOptions(OVERALL_NUMBER_GRADE_WITH_EMPTY_OPTIONS, currentUser.storeLevel);
        ...
        <>
            <div class="container">
                <section class="section">
                    ...
                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Online Comic Submission</p>
                        {isFetching
                            ?
                            ...
                            <>
                                ...
                                <div class="container">
                                    ...
                                    <p class="subtitle is-6"><FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Book Information</p>
                                    <hr />
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <button class="button is-medium is-primary is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Submit and Continue</button>
                                        </div>
                                    </div>
