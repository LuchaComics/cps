                                            ...
                                            <div class="hero-body">
                                                <p class="subtitle">
                                                    <div class="has-text-centered">
                                                        <a href={submission.findingsFormObjectUrl} target="_blank" rel="noreferrer" class="button is-large is-success is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faDownload} />&nbsp;Download PDF</a>
                                                    </div>
                                                </p>
                                            </div>
                                        </section>
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        {customerName === null
                                            ...
                                            <div class="column is-half has-text-right">
                                                <Link to={`/submissions/comics`} class="button is-medium is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to List</Link>
                                            </div>
                                            :
                                            <div class="column is-half has-text-right">
                                                <Link to={`/customer/${customerID}/comics`} class="button is-medium is-primary is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Customer</Link>
                                            </div>
                                        }
                                    </div>
                                </div>
