...
import { faArrowLeft, faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faGauge, faUsers, faEye, faCube, faMagnifyingGlass, faBalanceScale, faUser, faCogs, faBookOpen, faNewspaper, faArrowRight } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                   {customerName === null
                        ...
                        <>
                           ...
                           <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                               <ul>
                                   <li class=""><Link to={`/customer/${customerID}/comics`} aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail (Comics)</Link></li>
                               </ul>
                           </nav>
                       </>
                    }
                    ...
                    {/* Page */}
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Online Submission</p>
                        <div class="container">
                            ...
                            <section class="hero is-medium is-link">
                              <div class="hero-body">
                                <p class="title">
                                    <FontAwesomeIcon className="fas" icon={faBookOpen} />&nbsp;Comics
                                </p>
                                <p class="subtitle">
                                  ...
                                  {customerName === null
                                      ?
                                      <Link to={`/submissions/comics/add/search`}>Select&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                                      :
                                      <Link to={`/submissions/comics/add?customer_id=${customerID}&customer_name=${customerName}`}>Select&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                                  }
                                </p>
                              </div>
                            </section>
                            ...
                            <section class="hero is-medium is-info">
                              <div class="hero-body">
                                <p class="title">
                                    <FontAwesomeIcon className="fas" icon={faNewspaper} />&nbsp;Cards
                                </p>
                                <p class="subtitle">
                                  Currently we accept of standard size, non-sports cards.
                                  <br />
                                  <br />
                                  <Link><i>Coming soon</i></Link>
                                </p>
                              </div>
                            </section>
                            ...
                            <div class="columns pt-5">
                                ...
                                {customerName === null
                                    ...
                                    :
                                    <>
                                        <Link to={`/customer/${customerID}/sub`} class="button is-medium is-hidden-touch" ><FontAwesomeIcon className="fas" icon={faTimesCircle} />&nbsp;Cancel</Link>
                                        <Link to={`/customer/${customerID}/sub`} class="button is-medium is-fullwidth is-hidden-desktop" ><FontAwesomeIcon className="fas" icon={faTimesCircle} />&nbsp;Cancel</Link>
                                    </>
                                }
                                </div>
