...
function AccountChangePassword() {
  ...
  const onSubmitClick = (e) => {
    ...
    const submission = {
      // Convert to snake-case for API endpoint.
  ...
  function onAccountChangePasswordSuccess(response) {
    ...
    setTimeout(() => {
      ...
      console.log(
        "onAccountChangePasswordSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAccountChangePasswordError(apiErr) {
    ...
    setTimeout(() => {
      ...
      console.log(
        "onAccountChangePasswordError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
