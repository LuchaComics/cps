...
function StoreCreditListDesktop(props) {
                ...
                <table class="table is-fullwidth is-striped is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        ...
                        {listData && listData.results && listData.results.map(function(datum, i){
                            return <tr>
                                <td data-label="Business Function">{CREDIT_BUSINESS_FUNCTION_STATES[datum.businessFunction]}</td>
                                <td data-label="Offer">{datum.offerName}</td>
                                <td data-label="Status">{CREDIT_STATUS_STATES[datum.status]}</td>
...
export default StoreCreditListDesktop;
