...
function StorePurchaseListDesktop(props) {
                ...
                {listData && listData.results && listData.results.map(function (datum, i) {
                    return (
                        ...
                        <td data-label="Submission">
                            <Link target="_blank" rel="noreferrer" to={`/submissions/comic/${datum.comicSubmissionId}`}>
...
export default StorePurchaseListDesktop;
