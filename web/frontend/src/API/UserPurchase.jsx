...
import {
    CPS_USER_PURCHASES_API_ENDPOINT
} from "../Constants/API";


export function getUserPurchaseListAPI(filtersMap=new Map(), onSuccessCallback, onErrorCallback, onDoneCallback) {
    const axios = getCustomAxios();

    // The following code will generate the query parameters for the url based on the map.
    let aURL = CPS_USER_PURCHASES_API_ENDPOINT;
    filtersMap.forEach(
        (value, key) => {
