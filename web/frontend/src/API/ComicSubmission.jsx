...
import {
    ...
    CPS_COMIC_SUBMISSION_FILE_ATTACHMENTS_API_ENDPOINT
} from "../Constants/API";


export function getComicSubmissionListAPI(filtersMap=new Map(), onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
...
export function postComicSubmissionCreateAPI(data, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
...
export function getComicSubmissionDetailAPI(submissionID, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
...
export function putComicSubmissionUpdateAPI(decamelizedData, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
...
export function deleteComicSubmissionAPI(id, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
...
export function postComicSubmissionCustomerSwapOperationAPI(submissionID, customerID, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
    const data = {
...
export function postComicSubmissionCreateCommentOperationAPI(submissionID, content, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);
    const data = {
        submission_id: submissionID,
        content: content,
...
export function postComicSubmissionFileAttachmentCreateAPI(submissionID, formdata, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    const axios = getCustomAxios(onUnauthorizedCallback);

    axios.post(CPS_COMIC_SUBMISSION_FILE_ATTACHMENTS_API_ENDPOINT.replace("{id}", submissionID), formdata, {
        headers: {
