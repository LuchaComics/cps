...
export function postStoreCreateAPI(
  ...
  axios
    .post(CPS_ORGANIZATIONS_API_ENDPOINT, decamelizedData)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function putStoreUpdateAPI(
  ...
  axios
    .put(
      CPS_ORGANIZATION_API_ENDPOINT.replace("{id}", decamelizedData.id),
      decamelizedData,
    )
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function deleteStoreAPI(
  ...
  const axios = getCustomAxios(onUnauthorizedCallback);
  axios
    .delete(CPS_ORGANIZATION_API_ENDPOINT.replace("{id}", id))
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function postStoreCreateCommentOperationAPI(
  ...
  axios
    .post(CPS_ORGANIZATION_CREATE_COMMENT_OPERATION_API_ENDPOINT, data)
    .then((successResponse) => {
      const responseData = successResponse.data;
