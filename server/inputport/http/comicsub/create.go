...
func (h *Handler) unmarshalCreateRequest(ctx context.Context, r *http.Request) (*sub_c.ComicSubmissionCreateRequestIDO, error) {
...
func ValidateCreateRequest(dirtyData *sub_c.ComicSubmissionCreateRequestIDO) error {
	...
	if dirtyData.ServiceType != sub_s.ServiceTypeCPSCapsuleIndieMintGem {
		...
		// Perform indie-mint gem validation...
