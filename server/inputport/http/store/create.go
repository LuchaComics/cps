...
func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*sub_s.Store, error) {
...
func ValidateCreateRequest(dirtyData *sub_s.Store) error {
...
func MarshalCreateResponse(res *sub_s.Store, w http.ResponseWriter) {
