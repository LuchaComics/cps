...
func TestGenerateNumberForCPSAdministrationCSVExport(t *testing.T) {
...
func TestGenerateNumberForCPSAdministrationFor19999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPSAdministrationFor29999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPSAdministrationFor39999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPSAdministration(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
