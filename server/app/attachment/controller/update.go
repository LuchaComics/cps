...
import (
	...
	domain "github.com/LuchaComics/cps-backend/app/attachment/datastore"
...
func (impl *AttachmentControllerImpl) UpdateByID(ctx context.Context, req *AttachmentUpdateRequestIDO) (*domain.Attachment, error) {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		userStoreTimezone, _ := sessCtx.Value(constants.SessionUserStoreTimezone).(string)
		...
		if userRole != user_d.UserRoleRoot && os.StoreID != userStoreID {
		...
		os.StoreTimezone = userStoreTimezone
