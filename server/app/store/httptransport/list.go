...
import (
	...
	sub_s "github.com/LuchaComics/cps-backend/app/store/datastore"
...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	...
	f := &sub_s.StorePaginationListFilter{
		Cursor:          "",
		PageSize:        25,
...
func MarshalListResponse(res *sub_s.StorePaginationListResult, w http.ResponseWriter) {
...
func MarshalListAsSelectOptionResponse(res []*sub_s.StoreAsSelectOption, w http.ResponseWriter) {
	if err := json.NewEncoder(w).Encode(&res); err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
